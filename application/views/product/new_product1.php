            ...
            <div class="card-body">
                ...
                <form class="forms-sample">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="product_price" placeholder="input price" name="product_price">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="product_amount" class="col-sm-2 col-form-label">amount</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="product_amount" placeholder="input amount" name="product_amount">
                        </div>
                    </div>
                    <button type="submit" class="btn btn-danger btn-rounded mr-2">Submit</button>
